...
void main() async {
  ...
  // URL avec une date spécifique
  final date = '2025-10-08'; // Date d'aujourd'hui
  final url = 'https://clientmanagerapi.onrender.com/servers/$encodedEmail/$restaurantId/orders?date=$date';
  
  print('🔍 Test de l\'API des commandes avec date');
